    ...
    public function dashboard(Request $request)
{
    ...
    if (auth()->user()->role === 'kepala-bagian' && !$request->has('cabang_filter')) {
    ...
    return view('kepala-bagian.dashboard', compact('title', 'accountOfficers', 'nasabahs', 'suratPeringatans','aocabang', 'cabangs', 'kantorkas', 'currentUser', 'nasabahNames'));
}
...
//     return view('kepala-bagian.dashboard', compact('title', 'accountOfficers','nasabahs', 'suratPeringatans', 'cabangs', 'kantorkas', 'currentUser','nasabahNames'));
// }
...
public function update(Request $request, $no)
    {
        ...
        return redirect()->route('kepala-bagian.dashboard')->with('success', 'Data berhasil di update');
    }

public function deleteNasabah($no)
{
    Nasabah::find($no)->delete();
    return redirect()->route('kepala-bagian.dashboard')->with('success', 'Data berhasil di hapus');
}
...
public function addSurat(Request $request)
{
    ...
    try {
        ...
        return redirect()->route('kepala-bagian.dashboard')->with('success', 'Data berhasil ditambahkan');
    } catch (\Exception $e) {
